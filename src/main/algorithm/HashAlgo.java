...
/**
 * Hash算法大全 推荐使用FNVHash1算法
 * 
 * @author liuxueping
 * @mail liuxueping@benguo.cn Feb 12, 2014 10:36:51 AM
 */
public enum HashAlgo {
	...
	public static void main(String[] args) {
		HashAlgo alg = HashAlgo.FNV1_64_HASH;
		System.out.println(HashAlgo.CRC32_HASH.hash("中国人"));
		long h = 0;
