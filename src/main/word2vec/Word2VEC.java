...
import main.word2vec.domain.WordEntry;
...
//        learn.saveModel(new File("library/javaSkip1"));
        ...
        vec.loadJavaModel("d:/vector.mod");
...
//        System.out.println(vec2.distance(str));
        ...
        //男人 国王 女人 
//        System.out.println(vec.analogy("中国", "毛泽东思想", "毛泽东"));
//        System.out.println(vec2.analogy("毛泽东", "毛泽东思想", "邓小平"));
    ...
    public Set<String> getAnalogyWords(String word, int topN){
    	int loop = 1;
    	Set<String> words = new TreeSet<>();
    	Set<WordEntry> entries = distance(word);
